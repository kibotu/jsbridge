...
/// - Allows bridge commands to trigger UI updates across the app
///
/// **Why a singleton?**
/// - Status bar state is global to the app
/// - Needs to be accessible from both bridge commands and SwiftUI views
/// - Simpler than passing environment objects through the view hierarchy
public class SystemUIState: ObservableObject {
...
public class SystemBarsCommand: BridgeCommand {
